        ...
        <>
            ...
            <div className="App">
                <div className='h2Container'>
                    <h2 className='titleh2'>The NFT collection L'eau will be available soon. The pre-sales are open, you can contact the artist, Remi Benard on instagram by indicating the name of the painting and the amount in eth that you want to offer him  -->  remibenard17</h2>
                </div>
